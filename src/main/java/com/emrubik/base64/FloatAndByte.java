 ...
 * @version $Revision 1.0 $ 2018年9月11日 下午4:54:16
 */
public class FloatAndByte {
    /**
     * @param args 对于IEEE754编码。由float转换为IEEE754编码
     * @author Administrator @version1.0
     */
    public static void main(String[] args) {
        ...
        data = floatToBytes((float) 22);
        for (int i = 0; i < 4; i++) {
            System.out.println(Integer.toHexString(data[i] & 0xff));
        }
        byte [] bs= new byte[]{00,00,(byte)0xb0,0x41};
        System.out.println(bytesToFloat(bs));
    }
